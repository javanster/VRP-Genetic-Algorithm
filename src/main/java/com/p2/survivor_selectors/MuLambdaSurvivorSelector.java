 ...
 * 
 * Based on Simon, 2013, p. 128-130.
 * 
 */
public class MuLambdaSurvivorSelector implements SurvivorSelector {
    ...
    public Population selectSurvivors(ParameterObject parameters, Population parents, Population population) {
        ...
        List<Individual> selectedChildren = allChildrenGenerated.subList(0, mu);
